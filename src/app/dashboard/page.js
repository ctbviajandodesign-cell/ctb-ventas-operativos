...
export default function DashboardPage() {
  ...
  async function fetchDashboardData() {
    try {
      ...
      let pipelineQuery = supabase.from('cotizaciones').select('codigo, agencia, destino, estado, valor_total, valor_comision, valor_utilidad, created_at, comercial, numero_pasajeros, nombres_pasajeros, motivo_perdida, profiles!left(nombre, ciudad)').gte('created_at', startIso)
      ...
      if (targetIdForIndividual) {
        ...
        pipelineQuery = supabase.from('cotizaciones').select('codigo, agencia, destino, estado, valor_total, valor_comision, valor_utilidad, created_at, comercial, numero_pasajeros, nombres_pasajeros, motivo_perdida, profiles!inner(nombre, ciudad)').gte('created_at', startIso).eq('profiles.ciudad', activeCityFilter)
