...
export default function DashboardPage() {
  ...
  async function fetchDashboardData() {
    try {
      ...
      let pipelineQuery = supabase.from('cotizaciones').select('codigo, agencia, destino, estado, valor_total, valor_comision, valor_utilidad, created_at, comercial, numero_pasajeros, nombres_pasajeros, motivo_perdida, profiles!left(nombre, ciudad), ventas(id, estado, vouchers(codigo))').gte('created_at', startIso)
